...
>
  ...
  <!-- Avatar (we'll replace the icon with an image here) -->
  <div class="avatar glass">
    <img src="resources/images/hero/developer-illustration.png" alt="Developer Illustration" class="hero-image" />
  </div>
</div>
