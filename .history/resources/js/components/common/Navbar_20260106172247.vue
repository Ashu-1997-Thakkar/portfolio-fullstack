        ...
        <nav class="nav-links d-none d-md-flex">
          <v-btn
            ...
            :class="{
              ...
              'text-white': isDarkModel,  <!-- If theme is on, text is white -->
              'text-black': !isDarkModel,  // If theme is off, text is black
            }"
          >
            {{ link.name }}
          </v-btn>
        ...
        <div class="right-section d-none d-md-flex">
          ...
          <div class="theme-toggle-wrapper">
            <v-icon size="20" class="theme-icon">
              {{ isDarkModel ? 'mdi-white-balance-sunny' : 'mdi-moon-waning-crescent' }}
            </v-icon>
            <v-switch
              v-model="isDarkModel"
...
const isDarkModel = ref(false)  // Keep track of the theme toggle state.
